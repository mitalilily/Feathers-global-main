...
FEATHERS_LANDING_SERVER_NAME=$FEATHERS_LANDING_SERVER_NAME
FEATHERS_APP_SERVER_NAME=$FEATHERS_APP_SERVER_NAME
FEATHERS_ADMIN_SERVER_NAME=$FEATHERS_ADMIN_SERVER_NAME
FEATHERS_API_SERVER_NAME=$FEATHERS_API_SERVER_NAME
FEATHERS_PGADMIN_SERVER_NAME=$FEATHERS_PGADMIN_SERVER_NAME
EOF
fi
